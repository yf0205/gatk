...
public final class Mutect2 extends AssemblyRegionWalker {
    ...
    protected ReadsDownsampler createDownsampler() {
        final ReferenceDataSource referenceDataSource = new ReferenceFileSource(new File(referenceArguments.getReferenceFileName()));
        return new MutectDownsampler(maxReadsPerAlignmentStart, getHeaderForReads(), MTAC.maxLowQualSubstitutionsInRead, MTAC.maxSuspiciousReadsPerAlignmentStart, MTAC.downsamplingStride, referenceDataSource);
    }
