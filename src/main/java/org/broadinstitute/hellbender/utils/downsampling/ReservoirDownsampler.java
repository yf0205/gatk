...
public final class ReservoirDownsampler extends ReadsDownsampler {
    ...
    /**
     * We need to have consume the entire input stream before finalizing any items in order to guarantee
     * that all reads have equal probability of being discarded. All submitted items that survive downsampling
     * remain pending until endOfInputStream is seen, at which point all surviving items become finalized.
     */
