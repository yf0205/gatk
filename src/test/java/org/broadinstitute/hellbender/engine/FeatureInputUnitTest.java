...
public final class FeatureInputUnitTest extends GATKBaseTest {
    ...
    static class ArgumentContainer {
        ...
        public FeatureInput<VariantContext> fi;
    }

    @DataProvider(name = "InvalidFeatureArgumentDataProvider")
    public Object[][] getInvalidFeatureArguments() {
        return new Object[][] {
    ...
    private void populateFeatureInput(final String featureArgument, final String argumentValue) {
        ArgumentContainer ac = new ArgumentContainer();
        CommandLineArgumentParser clp = new CommandLineArgumentParser(ac);
        final String[] args = {"--" + featureArgument, argumentValue};
        clp.parseArguments(System.out, args);
    }

    @Test(dataProvider = "InvalidFeatureArgumentDataProvider", expectedExceptions = CommandLineException.class)
    public void testInvalidFeatureArgumentValue( final String invalidFeatureArgument ) {
        populateFeatureInput(invalidFeatureArgument, "value");
    }
...
//        populateFeatureInput("name", validFileOnlyFeatureArgumentValue);
//
